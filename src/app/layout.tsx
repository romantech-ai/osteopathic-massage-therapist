  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="osteopathic-massage-therapist";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Osteopathic Massage Therapist"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="osteopathic-massage-therapist"
          data-primary-color="#b6d780"
          defer
        ></script>
      </head>
